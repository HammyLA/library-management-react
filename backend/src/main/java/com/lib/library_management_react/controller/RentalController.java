...
public class RentalController {
    ...
    public RentalDetails getRentalDetails(@PathVariable Integer id) {
        ...
        // Use the memberId and bookId to fetch the associated Member and Book entities
        Member member = members.getById(rental.getMember());
        Book book = books.getBookById(rental.getBook());

        // Return the RentalDetails object
        return new RentalDetails(rental, member, book);
    }
