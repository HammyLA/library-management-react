...
('Pride and Prejudice', 'Pride and Prejudice was written by Jane Austen in 1813. Mainly falling into the romance novel category, the book follows the character Elizabeth Bennet, and her four sisters, and touches on manners, education, marriage, and money during the Regency era in Great Britain. Back then the importance of marrying for love rather than money or social prestige, wasn''t necessarily valued, which leads to an insightful look into cultural expectations.', 1813),
('The Very Hungry Caterpillar', 'The Very Hungry Caterpillar is a 1969 children''s picture book designed, illustrated, and written by American children''s author and illustrator Eric Carle. The plot follows a very hungry caterpillar that consumes a variety of foods before pupating and becoming a butterfly. It incorporates elements that contribute to early childhood education, including counting, days of the week, and food. It also incorporates a butterfly''s life cycle.', 1969);
